...
const {  resendOtp, login, logout, verifyLoginOtp, verifyOtpController, registerEmployer, getEmployerProfile, getAllEmployers, updateBasicDetailsOfEmployer, } = require("../controllers/employerControllers");
